...
{
    $id = $_GET['updateId'];
  $sql="SELECT batchNo FROM student_batchs WHERE batchno = '$id'";
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="./batchEditForm.css" />
  </head>
  <body>
    <header>
      <div class="top">
        ...
        <div class="courses">
          ...
          <ul class="tabs">
            <li data-tab-target="#add" class="active tab">
              <span class="material-symbols-outlined">add</span>Update
            </li>
          ...
          <div class="tab-content">
            <div id="add" data-tab-content class="active">
              <div class="Course-form">
                ...
                <form action="./server/editBatch.php" method="POST">
                  <div class="formFirst">
