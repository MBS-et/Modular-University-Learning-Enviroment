...
<head>
  ...
  <link rel="stylesheet" href="./batchForm.css" />
  <link rel="stylesheet" href="./batchTable.css">
</head>
...
<body>
  ...
  <div class="container">
    ...
    <main>
      <div class="courses">
        <h1 class="title">
          <span class="material-symbols-outlined">safety_divider</span>Batch
        </h1>
        <ul class="tabs">
              ...
              <form action="./server/addBatch.php" method="POST">
                <div class="formFirst">
                  ...
                  <div class="courseDetails">
                    ...
                    <span class="title">Batch Details</span>
                    <div class="fields">
                      <!-- fields for courseDetails -->
                      <div class="input-field">
                        <label>Batch</label>
                        <input type="text" name="name" placeholder="Enter Batch" required />
                      </div>
                      <div class="buttons">
            ...
            <div class="table-container">
              ...
              <table>
                ...
                <tbody>
                  ...
                  $sql = "SELECT `batchNo` FROM `student_batchs`";
                  $result = mysqli_query($con,$sql);
                  while ($row = $result->fetch_array())
                  {
                    echo "
                    <tr class='rows'>
                    <td><h3>" . $row["batchNo"] . "</h3></td>
                    <td> 
                                     <a class='btn btn-primary' role='button' data-bs-toggle='button' href='./editBatch.php?updateId=" . $row["batchNo"] . "'>Edit</a>
