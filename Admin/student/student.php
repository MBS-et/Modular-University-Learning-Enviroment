      ...
      <div class="students">
        ...
        <div class="tab-content">
          ...
          <div id="view" data-tab-content>
            <div class="table-container">
              <table>
                ...
                <tbody>
                  ...
                  $sql = "SELECT userName,firstName + ' ' + middleName + ' ' + lastName as Fullname ,mobileNumber,gender,email,batchNo FROM students";
                  $result = mysqli_query($con, $sql);
                  while ($row = $result->fetch_array()) {
                    echo "
            <tr class='rows'>
            ...
            <td>" . $row["batchNo"] . "</td>
            <td> 
                 <a class='btn btn-primary' role='button' data-bs-toggle='button' href='#'>Edit</a>
