      ...
      <main>
        <div class="students">
          ...
          <div class="tab-content">
            <div id="add" data-tab-content class="active"><div class="Student-form">
      <!-- container -->
          ...
          <div class="personalDetails">
            ...
            <div class="fields">
              ...
              <div class="input-field">
                ...
                <input type="text" placeholder="Enter your Name" name="MiddleName" required />
              </div>
              <div class="input-field">
          ...
          <div class="permanentAddress">
            ...
            <div class="fields">
              ...
              <div class="input-field">
               ...
               <div class="buttons">
                <button class="submit">
                  <input type="submit" name="submit" class="submit" ><label for="submit">
